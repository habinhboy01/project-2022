...
get_header(); ?>
	...
	<div class="container bg-wedding3">
		<div class="row">
			<div class="col-lg-8 col-12 content-hall">
				<p><?php the_field('content-hall1'); ?></p>

				<p><?php the_field('content-hall2'); ?></p>

				<h1><?php echo get_field('all-hall-about-us'); ?></h1>

				<!-- sảnh tulip -->

				<div class="row bg-hall">
					<?php if( have_rows('hall-tulip') ): ?>
			            <?php while( have_rows('hall-tulip') ): the_row(); 
			                $image = get_sub_field('img');
			                $picture = $image['sizes']['thumbnail']; 
			                $link = get_sub_field('link');
			                ?>

			                <div class="col-lg-6 col-12 content-hall" data-aos="flip-up" data-aos-duration="3000">
			                	<a href="<?php echo $link['url'];?>">
							...
							<div class="col-lg-6 col-12" data-aos="flip-down" data-aos-duration="3000">
								<a href="<?php echo $link['url'];?>">
				                	<img class="img-hall" src="<?php echo $picture;?>" alt="<?php echo $image['alt'];?>">
				                </a>
				            </div>
				...
				<div class="row bg-hall">
					<?php if( have_rows('hall-rose') ): ?>
			            <?php while( have_rows('hall-rose') ): the_row(); 
			                $image = get_sub_field('img');
			                $picture = $image['sizes']['thumbnail']; 
			                $link = get_sub_field('link');
			                ?>
				...
				<!-- SẢNH VIOLET -->
				<div class="row bg-hall">
					<?php if( have_rows('hall-violet') ): ?>
			            <?php while( have_rows('hall-violet') ): the_row(); 
			                $image = get_sub_field('img');
			                $picture = $image['sizes']['thumbnail']; 
			                $link = get_sub_field('link');
			                ?>
				...
				<!-- SẢNH CALLA -->
				<div class="row bg-hall">
					<?php if( have_rows('hall-calla') ): ?>
			            <?php while( have_rows('hall-calla') ): the_row(); 
			                $image = get_sub_field('img');
			                $picture = $image['sizes']['thumbnail']; 
			                $link = get_sub_field('link');
			                ?>
			...
			<div class="col-lg-4 col-12">
				<div class="bg-sidebar">
					<div class="categories">
						...
						<?php wp_nav_menu (
				    		array('theme_location' => 'menu-3', 'menu_class' => 'categories2'));?>
				   	</div>
