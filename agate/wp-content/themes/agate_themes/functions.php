...
function search_form( $form ) {
	$form = '<form class="searchform" role="search" method="get" action="' . home_url( '/' ) . '" > <input type="search" value="' . get_search_query() . '" name="s" id="s" placeholder="nhập từ khóa tìm Kiếm" /></form>';
	return $form;
	}
