...
trait Difference
{
    ...
    public function diffForHumans($other = null, $syntax = null, $short = \false, $parts = 1, $options = null)
    {
        ...
        return $this->diffAsCarbonInterval($other, \false, $skip)->setLocalTranslator($this->getLocalTranslator())->forHumans($syntax, (bool) $short, $parts, $options ?? $this->localHumanDiffOptions ?? static::getHumanDiffOptions());
    }
    /**
     * @alias diffForHumans
     *
