...
<head>
    ...
    <div class="bg-product7">
        <div class="container">
            <img id="img-singleton3" src="../../images/img128.png">

            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img149.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">thách thức <br> giác quan</p>

                    <img id="img-singleton4" src="../../images/img150.png">

                    <p class="text-malt text-singleton5">Ngay từ đoạn mở đầu, Lagavulin đã thách thức người
                        thưởng
                        thức bằng mùi hương của các loại hạt rang mật ong, dây thừng tẩm hắc ín và tuyết tùng
                        tươi
                        cắt nhỏ. Đậm đặc chất cổ điển, vị khói than bùn, hạt rau mùi, đường lúa mạch, bột thì
                        là, cá
                        hồi hun khói và bánh hạnh nhân của Lagavulin 8 Y.O tiếp tục quyến luyến trong vòm họng
                        và để
                        lại hậu vị khó quên với lớp táo vụn, hạnh nhân nướng và tro.</p>
                </div>
            </div>
        </div>
    </div>
