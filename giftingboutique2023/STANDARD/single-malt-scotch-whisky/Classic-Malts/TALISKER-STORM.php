...
<head>
    ...
    <div class="bg-product7">
        <div class="container">
            <img id="img-singleton3" src="../../images/img125.png">

            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img145.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">cuộc bùng nổ <br> hương vị</p>

                    <p class="text-malt text-singleton5">Ngọt ngào từ quả mọng chín đỏ,
                        mằn
                        mặn của muối và hăng cay bùng nổ của hạt tiêu, Talisker Storm bùng nổ như một
                        cơn
                        bão đích thực ngay từ những nốt hương đầu tiên. Vị whisky dịu dàng và phong phú,
                        theo sau bởi ấn tượng cay nồng, sau cùng để lại dư vị mượt mà kéo dài vừa phải
                        với
                        một chút than hồng cháy nhẹ.</p>
                </div>
            </div>
        </div>
    </div>
