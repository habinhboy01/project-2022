...
<head>
    <title>TALISKER PORT RUIGHE</title>
    <meta charset="utf-8">
    ...
    <div class="bg-product7">
        <div class="container">
            <img id="img-singleton3" src="../../images/img123.png">

            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img143.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">những mảng màu <br> đối lập</p>

                    <p class="text-malt text-singleton5">Từ thùng gỗ sồi Mỹ, Talisker
                        Port
                        Ruighe sau đó hoàn thiện chất vị độc đáo trong thùng cảng để hình thành nên tầng
                        hương ngọt ngào khói của bếp lửa sắp tàn cùng với trái mận chín. Bên cạnh vị
                        khói và
                        mặn chủ đạo, vị cay ban đầu được chuyển hóa như làn khói kem hòa quyện với gia
                        vị và
                        các loại trái cây sẫm màu.</p>
                </div>
            </div>
        </div>
    </div>
