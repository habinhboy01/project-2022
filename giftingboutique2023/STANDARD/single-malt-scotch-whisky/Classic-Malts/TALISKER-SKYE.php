...
<head>
    ...
    <div class="bg-product7">
        <div class="container">
            <img id="img-singleton3" src="../../images/img124.png">

            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img144.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">dư vị <br> của biển khơi</p>

                    <p class="text-malt text-singleton5">Talisker Skye mang hương cam
                        tươi,
                        rong biển, gỗ và muối biển, cùng hương khói đặc trưng rất quyến rũ. Chất vị khơi
                        gợi
                        xúc cảm khởi đầu nhẹ nhàng, sau đó nhanh chóng trở nên hăng và mặn hơn với vị
                        cay
                        nóng. Dư vị lưu lại trong thời gian vừa phải, kết thúc với vị tiêu mịn màng và
                        khói
                        ngọt ngào.</p>
                </div>
            </div>
