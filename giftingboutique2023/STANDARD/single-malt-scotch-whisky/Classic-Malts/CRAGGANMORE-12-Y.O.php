...
<head>
    <title>CRAGGANMORE 12 Y.O</title>
    <meta charset="utf-8">
    ...
    <div class="bg-product7">
        <div class="container">
            <img id="img-singleton3" src="../../images/img126.png">

            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img146.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">phiêu lưu <br> hoang dã</p>

                    <img id="img-singleton4" src="../../images/img147.png">

                    <p class="text-malt text-singleton5">Trưởng thành bên đoạn siết nhất của vùng
                        Speyside
                        cùng nguồn nguyên liệu đa dạng, Cragganmore đưa người thưởng ngoạn vào chuyến
                        phiêu
                        lưu lấp lánh về quá khứ huy hoàng – thâm trầm, sâu thẳm nhưng đầy phóng khoáng
                        và
                        hoang dã của hương hoa kim ngân, gia vị, hạnh nhân hun khói. Hương vỏ chanh,
                        trái
                        cây chín và da thuộc, gỗ sồi hòa quyện trên nền khói nhẹ. Tất cả đều được hòa
                        quyện
                        nhẹ nhàng và độc đáo.</p>
                </div>
            </div>
        </div>
    </div>
