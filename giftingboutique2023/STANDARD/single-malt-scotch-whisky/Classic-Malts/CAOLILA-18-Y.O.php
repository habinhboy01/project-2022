        ...
        <div class="container">
            ...
            <div class="row bg-product8">
                <div class="col-lg-6 col-md-6 col-12">
                    <img class="img-singleton5" src="../../images/img152.png">
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <p class="text-singleton6">bản hòa ca <br> đối lập</p>

                    <img id="img-singleton4" src="../../images/img142.png">

                    <p class="text-malt text-singleton5">Caol Ila được xem như “bản hòa ca thanh thoát và sâu
                        sắc
                        của hoa bia, đinh hương, cỏ ướt và chút cá xông khói”. Trưởng thành trong thùng gỗ sồi
                        Mỹ,
                        Caol Ila 18 Y.O thoảng mùi thơm và hắc của thảo dược, thực vật, cỏ và mạch nha dạng kem.
                        Sau
                        vị ngọt thanh của thảo dược, whisky áp đảo vòm họng với gỗ sồi, khói, dầu, than bùn và
                        lúa
                        mạch, cuối cùng để lại hậu vị thảo mộc kéo dài, đượm hương khói nhẹ nhàng.</p>
                </div>
            </div>
        </div>
    </div>
