...
<head>
    <title>JOHNNIE WALKER BLACK ICON 3.0</title>
    <meta charset="utf-8">
    ...
    <!-- Nâng ly vì chiến thắng Johnnie Keep Walking. -->

    <div class="keep-walking">
        <img class="img-walker img-walker4" src="../../images/img29.png">

        <img class="img-walker img-walker3" src="../../images/img29-1.png">

        <h2 class="text-keep">Nâng ly vì chiến thắng <br> Johnnie Keep Walking.</h2>
    </div>


    <!-- slider 2 -->

    <div class="keep-walking2">
        <div class="keep-walking">
            <img class="img-walker" src="../../images/img31.png">

            <h2 class="text-keep2">Dẫn đầu không bắt chước không sợ bước lạc đường, nỗ lực ngàn phần trăm những
                tâm
                hồn mạnh mẽ</h2>
        </div>
    </div>
