        ...
        <div class="row rare-nature2">
            ...
            <div class="col-lg-6 col-12">
                <div class="content-prima-ultima3">
                    ...
                    <img id="img-rare-nature" src="../../images/img87.png">

                    <p class="text-prima2 text-rare-nature">Là “Nữ hoàng mạch nha đơn của vùng Speyside”,
                        Cardhu
                        11 Y.O được ủ trong thùng gỗ sồi Mỹ Bourbon cũ theo từng mẻ nhỏ, tạo ra một phức hợp
                        ngọt ngào giữa hoa, vị khô và cay nồng như một cuộc trao đổi vui nhộn giữa gỗ và
                        rượu
                        whisky. Thanh lịch và hoàn hảo, Cardhu 11 Y.O để lại kết thúc ấn tượng với vị nồng
                        ấm
                        kéo dài.</p>
