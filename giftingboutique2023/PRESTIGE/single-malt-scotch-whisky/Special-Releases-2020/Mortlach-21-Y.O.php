        ...
        <div class="row rare-nature2">
            ...
            <div class="col-lg-6 col-12">
                <div class="content-prima-ultima3">
                    ...
                    <img id="img-rare-nature" src="../../images/img86.png">

                    <p class="text-prima2 text-rare-nature">Quá trình chưng cất độc đáo 2.81 lần với 21 năm
                        ủ
                        ròng rã trong thùng gỗ Pedro Ximenez và Oloroso đã tạo nên một Mortlach 21 Y.O có
                        hương
                        vị nổi trội. Với bản chất mạnh mẽ vốn có cùng dư vị huy hoàng, “Quái thú vùng
                        Dufftown”
                        này ít được biết đến vì luôn được giấu kín trong thế giới Tầng vị whisky.</p>
