                                    ...
                                    <div class="row align-items-center">
                                        <div class="collect-wedding-slider__item-left collect-slider__item-left">
                                            <div class="collect-wedding-slider__product-image collect-slider__product-image">
                                                <img class="w-100" src="../images/M-Nu Hon Vang.png" alt="M-Nu Hon Vang">
                                            </div>
                                        </div>
                                        <div class="collect-wedding-slider__item-right collect-slider__item-right">
                                            <div class="collect-wedding-slider__product-content collect-slider__product-content">
                                                ...
                                                <div class="collect-wedding-slider__product-desc collect-slider__product-desc font-style-04 cl-white lf-text-justify">
                                                    Danh họa Gustav Klimt nổi tiếng
                                                    với những tác phẩm sơn dầu dát
                                                    vàng. Vàng óng ánh làm hình ảnh
                                                    trở nên lấp lánh, huy ền ảo, bên
                                                    cạnh những họa tiết kỷ hà hiện
                                                    đại, độc đáo. Lấy cảm hứng từ bức
                                                    tranh “The Kiss” của Gustav Klimt, tác phẩm Nụ Hôn Vàng được
                                                    khắc
                                                    họa lại trên thân chai Mortlach trong vườn hồng xanh huyền ảo;
                                                    một vài cánh hồng trên nền chai
                                                    kết hợp với chất rượu sóng sánh
                                                    càng làm hình ảnh thêm tinh tế.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
