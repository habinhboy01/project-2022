...
<body>
    ...
    <div class="container-fluid bg-about">
    	...
    	<h1><?php echo get_field('management'); ?></h1>

		<?php if( have_rows('list-management') ): ?>
            <?php while( have_rows('list-management') ): the_row(); 
        ...
        <h1><?php echo get_field('editorial'); ?></h1>

		<?php if( have_rows('editorial-department') ): ?>
            <?php while( have_rows('editorial-department') ): the_row(); 
                $icon = get_sub_field('name'); ?>
        ...
        <h1><?php echo get_field('creative'); ?></h1>

		<?php if( have_rows('creative-department') ): ?>
            <?php while( have_rows('creative-department') ): the_row(); 
                $icon = get_sub_field('name'); ?>
        ...
        <h1><?php echo get_field('advertising'); ?></h1>

		<?php if( have_rows('sale-department') ): ?>
            <?php while( have_rows('sale-department') ): the_row(); 
                $icon = get_sub_field('name'); ?>
        ...
        <h1><?php echo get_field('marketing'); ?></h1>

		<?php if( have_rows('marketing-department') ): ?>
            <?php while( have_rows('marketing-department') ): the_row(); 
                $icon = get_sub_field('name'); ?>
